...
export class FontDirective {
  ...
  constructor(private _renderer: Renderer2, private _eleRef: ElementRef) {}
  ...
  private setFontWeight(param) {
    if (param) {
      switch (param) {
        ...
        default:
          console.error(
            'invalid font weight value , please use any one : xl-light,light,reg,thin,md,bold,semi-bold,xl-bold'
          );
